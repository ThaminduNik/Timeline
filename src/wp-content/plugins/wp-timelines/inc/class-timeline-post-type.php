...
class WPEX_TL_Posttype {
	...
	function register_metadata(array $meta_boxes){
		...
		$custom_date = array(
			...
			array( 'id' => 'wpex_pkdate',  'name' => esc_html__('Actual timeline date','wp-timeline'), 'cols' => 6, 'readonly' => false, 'type' => 'text','allow_none' => true, 'desc' => esc_html__('Select date', 'wp-timeline'), 'sortable' => false, 'repeatable' => false ),
			array( 'id' => 'wpex_date',  'name' => esc_html__('Date - text format','wp-timeline'), 'cols' => 6, 'type' => 'text','allow_none' => true, 'desc' => esc_html__('Ex: 19 02 1945 or 19/02/1945 (auto replace to timeline date)', 'wp-timeline'), 'sortable' => false, 'repeatable' => false ),
			array( 'id' => 'wpex_sublabel',  'name' => esc_html__('Actual milstone title','wp-timeline'), 'cols' => 6, 'type' => 'text','allow_none' => true, 'desc' => esc_html__('Enter Sub label', 'exthemes'), 'sortable' => false, 'repeatable' => false ),
			array( 'id' => 'wpex_felabel',  'name' => esc_html__('Timeline year','wp-timeline'), 'cols' => 6, 'type' => 'text','allow_none' => true, 'desc' => esc_html__('Only used for Timeline Listing shortcode', 'wp-timeline'), 'sortable' => false, 'repeatable' => false ),
		);
		...
		$speaker_settings = array(	
				...
				array( 'id' => 'wpex_custom_metadata',  'name' => esc_html__('Content type', 'wp-timeline'), 'type' => 'text', 'repeatable' => true, 'multiple' => true ,'cols' => 6),
