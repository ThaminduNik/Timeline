...
class mo_login_wid extends WP_Widget {
	...
	public function loginForm(){
		...
		if(!empty($identity_provider) && !empty($saml_x509_certificate)){
				echo '<div id="sso_widget_div"style="display: none;" ><button href="#" id="sso_widget" style="background-color: #f79468 !important;border-radius: 73px !important;font-size: 14px;" onClick="submitSamlForm()">Login with ' . $identity_provider . '</button></div></form>';
		}else
