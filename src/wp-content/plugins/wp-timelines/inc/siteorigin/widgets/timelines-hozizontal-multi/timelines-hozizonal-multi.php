<?php
/*
Widget Name: Timelines Horizontal Multi item
...
class SiteOrigin_Widget_WPTL_Hozi_Multi_Widget extends SiteOrigin_Widget {
	function __construct() {
		...
		parent::__construct(
			...
			__( 'Timelines Horizontal Multi item', 'wp-timeline' ),
			array(
				'description' => __( 'A timeline Horizontal Multi item widget.', 'wp-timeline' ),
				'help' => '',
			),
			array(),
			false,
