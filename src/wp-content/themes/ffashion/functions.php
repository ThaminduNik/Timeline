...
function ffashion_setup() {
	...
	$starter_content = array(
		...
		'attachments' => array(
			'image-slide-1' => array(
				'post_title' => _x( 'Slider Image 1', 'Theme starter content', 'ffashion' ),
				'file' => 'images/slider/1.png', // URL relative to the template directory.
			),
			'image-slide-2' => array(
				'post_title' => _x( 'Slider Image 2', 'Theme starter content', 'ffashion' ),
				'file' => 'images/slider/2.png', // URL relative to the template directory.
			),
			'image-slide-3' => array(
				'post_title' => _x( 'Slider Image 3', 'Theme starter content', 'ffashion' ),
				'file' => 'images/slider/3.png', // URL relative to the template directory.
			),
		),
		...
		'theme_mods' => array(
			'ffashion_slider_display' => 1,
			'ffashion_slide1_image' => '{{image-slider-1}}',
			'ffashion_slide1_content' => _x( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 'Theme starter content', 'ffashion' ),
			'ffashion_slide2_image' => '{{image-slider-2}}',
			'ffashion_slide2_content' => _x( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 'Theme starter content', 'ffashion' ),
			'ffashion_slide3_image' => '{{image-slider-3}}',
			'ffashion_slide3_content' => _x( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 'Theme starter content', 'ffashion' ),
			'ffashion_social_facebook' => _x( '#', 'Theme starter content', 'ffashion' ),
			'ffashion_social_twitter' => _x( '#', 'Theme starter content', 'ffashion' ),
			'ffashion_social_linkedin' => _x( '#', 'Theme starter content', 'ffashion' ),
			'ffashion_social_instagram' => _x( '#', 'Theme starter content', 'ffashion' ),
			'ffashion_social_rss' => _x( '#', 'Theme starter content', 'ffashion' ),
			'ffashion_social_tumblr' => _x( '#', 'Theme starter content', 'ffashion' ),
			'ffashion_social_youtube' => _x( '#', 'Theme starter content', 'ffashion' ),
			'ffashion_social_pinterest' => _x( '#', 'Theme starter content', 'ffashion' ),
			'ffashion_social_vk' => _x( '#', 'Theme starter content', 'ffashion' ),
			'ffashion_social_flickr' => _x( '#', 'Theme starter content', 'ffashion' ),
			'ffashion_social_vine' => _x( '#', 'Theme starter content', 'ffashion' ),
		),
	...
	$starter_content = apply_filters( 'ffashion_starter_content', $starter_content );
...
function ffashion_display_social_sites() {
	...
	if ( !empty($socialURL) ) {
		...
		echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Facebook', 'ffashion') . '" class="facebook16"></a></li>';
	}

	$socialURL = get_theme_mod('ffashion_social_twitter');
	if ( !empty($socialURL) ) {

		echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Twitter', 'ffashion') . '" class="twitter16"></a></li>';
	}

	$socialURL = get_theme_mod('ffashion_social_linkedin');
	if ( !empty($socialURL) ) {

		echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on LinkeIn', 'ffashion') . '" class="linkedin16"></a></li>';
	}

	$socialURL = get_theme_mod('ffashion_social_instagram');
	if ( !empty($socialURL) ) {

		echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Instagram', 'ffashion') . '" class="instagram16"></a></li>';
	}

	$socialURL = get_theme_mod('ffashion_social_rss');
	if ( !empty($socialURL) ) {

		echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow our RSS Feeds', 'ffashion') . '" class="rss16"></a></li>';
	}

	$socialURL = get_theme_mod('ffashion_social_tumblr');
	if ( !empty($socialURL) ) {

		echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Tumblr', 'ffashion') . '" class="tumblr16"></a></li>';
	}

	$socialURL = get_theme_mod('ffashion_social_youtube');
	if ( !empty($socialURL) ) {

		echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Youtube', 'ffashion') . '" class="youtube16"></a></li>';
	}

	$socialURL = get_theme_mod('ffashion_social_pinterest');
	if ( !empty($socialURL) ) {

		echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Pinterest', 'ffashion') . '" class="pinterest16"></a></li>';
	}

	$socialURL = get_theme_mod('ffashion_social_vk');
	if ( !empty($socialURL) ) {

		echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on VK', 'ffashion') . '" class="vk16"></a></li>';
	}

	$socialURL = get_theme_mod('ffashion_social_flickr');
	if ( !empty($socialURL) ) {

		echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Flickr', 'ffashion') . '" class="flickr16"></a></li>';
	}

	$socialURL = get_theme_mod('ffashion_social_vine');
	if ( !empty($socialURL) ) {

		echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Vine', 'ffashion') . '" class="vine16"></a></li>';
	}
...
if ( ! function_exists( 'ffashion_sanitize_checkbox' ) ) :
	/**
...
endif; // ffashion_sanitize_checkbox

if ( ! function_exists( 'ffashion_sanitize_html' ) ) :

	function ffashion_sanitize_html( $html ) {
		return wp_filter_post_kses( $html );
	}

endif; // ffashion_sanitize_html

if ( ! function_exists( 'ffashion_sanitize_url' ) ) :

	function ffashion_sanitize_url( $url ) {
		return esc_url_raw( $url );
	}

endif; // ffashion_sanitize_url
...
function ffashion_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'ffashion_header_logo',
		array(
			'default' => '',
    		'sanitize_callback' => 'ffashion_sanitize_url'
		)
	);
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'ffashion_slider_display',
							array(
								'label'          => __( 'Display Slider on a Static Front Page', 'ffashion' ),
	...
	$wp_customize->add_setting(
		...
		array(
		    'sanitize_callback' => 'ffashion_sanitize_html',
		)
	);
