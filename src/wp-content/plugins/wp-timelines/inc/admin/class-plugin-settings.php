...
class WPEX_Timeline_Settings {
	...
	private function settings_fields() {
		...
		$settings['js-css'] = array(
			'title'					=> esc_html__( 'Js & Css file', 'wp-timeline' ),
			'description'			=> '',
			'fields'				=> array(
				array(
					'id' 			=> 'wpex_load_css',
				...
				array(
					'id' 			=> 'wpex_style_sbs',
					'label'			=> esc_html__( 'Turn off css file of Timeline Side by side', 'wp-timeline' ),
					'description'	=> esc_html__( "Check if you not using Timeline Side by side style", 'wp-timeline' ),
					'type'			=> 'checkbox',
					'default'		=> ''
				),
				array(
					'id' 			=> 'wpex_style_hoz',
					'label'			=> esc_html__( 'Turn off css file of Horizontal', 'wp-timeline' ),
					'description'	=> esc_html__( "Check if you not using Horizontal style", 'wp-timeline' ),
					'type'			=> 'checkbox',
					'default'		=> ''
				),
			)
