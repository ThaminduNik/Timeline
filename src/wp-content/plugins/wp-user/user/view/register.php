<div role="tabpanel" class="tab-pane  hide <?php echo $register_class ?>"
        ...
        <div class="col-xs-12">
            ...
            <form method="post" onsubmit="return false" id="google_form<?php echo $form_id ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                    <div class="col-xs-12">
                        <input type="submit" style="width:100%" class="wpuser_button btn <?php echo $wp_user_appearance_button_type ?> btn-primary"
                               id="wpuser_register<?php echo $form_id ?>" name="wpuser_register"
                               value="<?php _e('Register', 'wpuser') ?>">

                    
                    <div>
                    <span class="new-font-login" style="">Already a member?</span>

                    <span class="new-font-login color-link">
                    <a aria-controls="loginController<?php echo $form_id ?>" role="tab" data-toggle="tab"
                    href="#loginController<?php echo $form_id ?>" class=""><?php _e('Login here', 'wpuser') ?></a>
                   </span>
                   </div>
                   </div>
                </div>
