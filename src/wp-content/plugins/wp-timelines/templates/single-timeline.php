...
<div class="wp-line-back"> <a href="#" onclick="history.go(-1)"> <img src='http://syscolabs.cleato.com/wp-content/uploads/2019/06/arrow.svg'/> </a> </div>        
<div class="wpex-info-sp">
            <div class="speaker-details">
            	
                <h1 class="tl-title">
<?php echo  '<span>'.the_title().'</span></br><span style="font-size: 16px;">'.wpex_date_tl().'</span>'; ?>
				</h1>
                ...
                <div class="exclearfix new-new-border-b"></div>
            </div>
        </div>
		<?php
	endwhile;?>
