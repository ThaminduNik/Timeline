...
class WPEX_TL_SCPosttype {
	...
	function register_metadata(array $meta_boxes){
		...
		$vertical_inf = array(
			...
			array( 'id' => 'full_content', 'name' => esc_html__('Show full Content', 'wp-timeline'), 'type' => 'select', 'allow_none' => false, 'sortable' => false,'repeatable' => false , 'cols' => 4, 'desc' => esc_html__('Show full Content instead of Excerpt or in Lightbox', 'wp-timeline'),
				'options' => array( 
						'' => esc_html__('No', 'wp-timeline'),
		...
		$hoz_inf = array(
			...
			array( 'id' => 'enable_back', 'name' => esc_html__('Enable Back to timeline page', 'wp-timeline'), 'type' => 'select', 'allow_none' => false, 'sortable' => false,'repeatable' => false , 'cols' => 6, 'desc' => esc_html__('Only works with timeline post type', 'wp-timeline'),
				'options' => array( 
						'' => esc_html__('No', 'wp-timeline'),
						'yes'=> esc_html__('Yes', 'wp-timeline')
				)
		...
		$hoz_multi_inf = array(
			array( 'id' => 'style', 'name' => 'Style', 'type' => 'select', 'allow_none' => false, 'sortable' => false,'repeatable' => false , 'cols' => 6,
				'options' => array( 
						...
						'6' => esc_html__('Style 6', 'wp-timeline'),
				)
			),
		...
		$meta_boxes[] = array(
			'title' => esc_html__('Timeline Horizontal','wp-timeline'),
			'pages' => $mt_pt,
			'fields' => $hoz_inf,
			'priority' => 'high'
		);
		$meta_boxes[] = array(
			'title' => esc_html__('Timeline Horizontal Multi','wp-timeline'),
			'pages' => $mt_pt,
