...
class EXC_MB_Select extends EXC_MB_Field {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'select2_351-exthemes', trailingslashit( EXC_MB_URL ) . 'js/vendor/select2_351/select2_351.js', array( 'jquery' ) );
		wp_enqueue_script( 'field-select-exthemes', trailingslashit( EXC_MB_URL ) . 'js/field.select.js', array( 'jquery', 'select2_351-exthemes', 'exc_mb-scripts' ) );
	}
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'select2_351-exthemes', trailingslashit( EXC_MB_URL ) . 'js/vendor/select2_351/select2_351.css' );
	}
