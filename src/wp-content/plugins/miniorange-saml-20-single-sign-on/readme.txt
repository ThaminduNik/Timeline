...
miniOrange SAML 2.0 SP Single Sign On (SSO) allows users residing at SAML 2.0 capable Identity Provider to login to your WordPress website. We support all known IdPs - Google Apps, ADFS, Azure AD, Okta, Salesforce, Shibboleth, SimpleSAMLphp, OpenAM, Centrify, Ping, RSA, IBM, Oracle, OneLogin, Bitium, WSO2, NetIQ etc.
...
Visit Help & FAQ section in the plugin OR email us at info@xcurify.com or <a href="http://miniorange.com/contact">Contact us</a>. You can also submit your query from plugin's configuration page.
