 ...
 ?>
       ...
       $(this).attr('disabled',true);
        if ( $("#google_form<?php echo $form_id ?>").valid() ) {
            ...
            $.ajax({
                ...
                error: function (data) {
                    $("#loader_action").hide();
                    $("#wpuser_register<?php echo $form_id ?>").attr('disabled',false);
                },
    ...
    $("#wpuser_login<?php echo $form_id ?>").click(function () {
       ...
       $(this).attr('disabled',true);
        ...
        error: function (data) {
            $("#loader_action").hide();
             $("#wpuser_login<?php echo $form_id ?>").attr('disabled',false);
        ...
        success: function (data) {
            var parsed = $.parseJSON(data);
             if ( parsed.status == 'success' ) {
                ...
                else if ( wpuser.login_redirect == null || wpuser.login_redirect.length === 0 ) {
                    location.reload();
                }
                else {
...
<?php } ?>
    ...
    $("#wpuser_forgot<?php echo $form_id ?>").click(function () {
      ...
      $(this).attr('disabled',true);
        ...
        error: function (data) {
            $("#loader_action").hide();
            $("#wpuser_forgot<?php echo $form_id ?>").attr('disabled',false);
        },
        success: function (data) {
            var parsed = $.parseJSON(data);
